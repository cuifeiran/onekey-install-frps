...
program_version_link="https://raw.githubusercontent.com/cuifeiran/onekey-install-frps/master/version.sh"
str_install_shell=https://raw.githubusercontent.com/cuifeiran/onekey-install-frps/master/install-frps.sh
shell_update(){
    fun_clangcn "clear"
